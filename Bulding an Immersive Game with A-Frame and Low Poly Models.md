...
**tutorial** [tu'tɔrɪəl] 教程；(n.)個別指導

**medieval** [,midɪ'ivəl] 中世紀；(adj.)中世紀的，原始的，仿中世紀的，老式的

**interaction** [,ɪntə'rækʃən] 相互作用；(n.)相互作用，[數] 交互作用；(n.)互動

**programmatically** 編程；以編程方式

**landscape** ['lænd'skep] 景觀；(n.)風景，風景畫，景色，山水畫，鄉村風景畫，地形，（文件的）橫向打印格式；(vt.)對…做景觀美化，從事庭園設計；(vi.)美化（環境等），從事景觀美化工作

**immersed** [i'mə:st] 沉浸；(adj.)浸入的，專注的；(v.)浸（immerse的過去式和過去分詞），沉湎於

**environment** [ɪn'vaɪrənmənt] 環境；(n.)環境

**tweaks** [twik] 擰；(n.)扭，擰，焦急；(vt.)扭，用力拉，開足馬力
